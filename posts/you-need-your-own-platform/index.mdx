---
title: "Building Your Own Platform: The Importance of Having a Personal Website"
date: "2023-01-30"
...
Blogging regularly on my continually evolving site has been a factor in getting noticed by potential employers and landing my first full-time role as a developer. It has provided a platform to demonstrate my skills and passion for the field. The blog became a topic of discussion during job interviews, and I've had the valuable opportunity to explain my thought process in building the site and my experience with different technologies.
...
In building your personal website, here is a checklist of what I consider mandantory requirements:

- A visually appealing design that aligns with your personal style
- Responsive and works on a variety of screen sizes
- High performance with perfect or near perfect Lighthouse scores
- Built with accessibility in mind ensuring everyone can access and use the site

With that established going forward, you can decide on functionality. The functionality of your website depends on your current needs and priorities. If you're looking where to start, I suggest you consider incorporating the following features:

- Focus on using in-demand technology
...
After consulting with my mentor, I decided to focus on TypeScript, React, Next.js, and GraphQL for frontend development, as this stack offers comprehensive full-stack capabilities. You can easily achieve anything described in this guide with this stack, and these choices are in high demand within the industry.
